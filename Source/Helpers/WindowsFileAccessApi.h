...
#ifndef NUCLEX_SUPPORT_HELPERS_WINDOWSFILEACCESSAPI_H
#define NUCLEX_SUPPORT_HELPERS_WINDOWSFILEACCESSAPI_H
...
#endif // NUCLEX_SUPPORT_HELPERS_WINDOWSFILEACCESSAPI_H
