...
#ifndef NUCLEX_SUPPORT_SERVICES_STANDARDBINDINGSET_H
#define NUCLEX_SUPPORT_SERVICES_STANDARDBINDINGSET_H
...
#endif // NUCLEX_SUPPORT_SERVICES_STANDARDBINDINGSET_H
