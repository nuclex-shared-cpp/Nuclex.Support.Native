...
namespace Nuclex {
  ...
  /// <summary>Uppercase versions of all unicode characters that have two cases</summary>
  /// <remarks>
  ...
  const char32_t uppercase[] = {
    ...
    0x104CE, 0x104CF, 0x104D0, 0x104D1, 0x104D2, 0x104D3, 0x10C80, 0x10C81,
    ...
    0x10CB2, 0x118A0, 0x118A1, 0x118A2, 0x118A3, 0x118A4, 0x118A5, 0x118A6,
    ...
    0x118BF, 0x16E40, 0x16E41, 0x16E42, 0x16E43, 0x16E44, 0x16E45, 0x16E46,
    ...
    0x16E5F, 0x1E900, 0x1E901, 0x1E902, 0x1E903, 0x1E904, 0x1E905, 0x1E906,
  ...
  /// <summary>Lowercase versions of all unicode characters that have two cases</summary>
  /// <remarks>
  ///   This table is taken from http://www.unicode.org/faq/casemap_charprop.html and is
  ...
  const char32_t lowercase[] = {
    ...
    0x1FA7, 0x1FB0, 0x1FB1, 0x1F70, 0x1F71, 0x1FB3, 0x03B9, 0x1F72,
    0x1F73, 0x1F74, 0x1F75, 0x1FC3, 0x1FD0, 0x1FD1, 0x1F76, 0x1F77,
    0x1FE0, 0x1FE1, 0x1F7A, 0x1F7B, 0x1FE5, 0x1F78, 0x1F79, 0x1F7C,
    0x1F7D, 0x1FF3, 0x03C9, 0x006B, 0x00E5, 0x214E, 0x2170, 0x2171,
    0x2172, 0x2173, 0x2174, 0x2175, 0x2176, 0x2177, 0x2178, 0x2179,
    0x217A, 0x217B, 0x217C, 0x217D, 0x217E, 0x217F, 0x2184, 0x24D0,
    ...
    0x24E9, 0x2C30, 0x2C31, 0x2C32, 0x2C33, 0x2C34, 0x2C35, 0x2C36,
    0x2C37, 0x2C38, 0x2C39, 0x2C3A, 0x2C3B, 0x2C3C, 0x2C3D, 0x2C3E,
    0x2C3F, 0x2C40, 0x2C41, 0x2C42, 0x2C43, 0x2C44, 0x2C45, 0x2C46,
    0x2C47, 0x2C48, 0x2C49, 0x2C4A, 0x2C4B, 0x2C4C, 0x2C4D, 0x2C4E,
    0x2C4F, 0x2C50, 0x2C51, 0x2C52, 0x2C53, 0x2C54, 0x2C55, 0x2C56,
    0x2C57, 0x2C58, 0x2C59, 0x2C5A, 0x2C5B, 0x2C5C, 0x2C5D, 0x2C5E,
    0x2C61, 0x026B, 0x1D7D, 0x027D, 0x2C68, 0x2C6A, 0x2C6C, 0x0251,
    ...
    0x0265, 0xA791, 0xA793, 0xA797, 0xA799, 0xA79B, 0xA79D, 0xA79F,
    0xA7A1, 0xA7A3, 0xA7A5, 0xA7A7, 0xA7A9, 0x0266, 0x025C, 0x0261,
    0x026C, 0x026A, 0x029E, 0x0287, 0x029D, 0xAB53, 0xA7B5, 0xA7B7,
    0xA7B9, 0xA7BB, 0xA7BD, 0xA7BF, 0xA7C3, 0xA794, 0x0282, 0x1D8E,
  ...
  ///   it may result in zero-characters embedded that would be noticed this way) and
  ///   to ensure the table is correct (if you imported a reverse case-folding table that
  ...
  void verifyCharacterSizesDontIncrease() {
    for(std::size_t index = 0; index < characterCount(); ++index) {
      ...
      } else if(uppercase[index] < char32_t(0xFFFF)) { // 110xxxxx 10xxxxxx
        //assert(lowercase[index] > char32_t(0x7F));
        assert(lowercase[index] < char32_t(0xFFFF));
      } else if(uppercase[index] < char32_t(0xFFFFFF)) { // 1110xxxx 10xxxxxx 10xxxxxx
        //assert(lowercase[index] > char32_t(0xFFFF));
        assert(lowercase[index] < char32_t(0xFFFFFF));
      }
    }
  }
#endif
