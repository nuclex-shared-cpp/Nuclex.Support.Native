...
#ifndef NUCLEX_SUPPORT_COLLECTIONS_MULTICACHE_H
#define NUCLEX_SUPPORT_COLLECTIONS_MULTICACHE_H
...
namespace Nuclex { namespace Support { namespace Collections {
  ...
  /// <summary>
  ///   Special type of multi-map that is able to evict its least recently used items
  /// </summary>
  ...
  class MultiCache : public MultiMap<TKey, TValue> {

    /// <summary>Frees all memory used by the cache</summary>
    public: virtual ~MultiCache() = default;
