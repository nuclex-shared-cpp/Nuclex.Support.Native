...
namespace Nuclex::Support::Services2::Private {
  ...
  struct ConstructorSignatureDetector<
    ...
    typename std::enable_if<
      ArgumentCount <= MaximumConstructorArgumentCount
    >::type
  > {
    typedef typename ConstructorSignatureDetectorWithIndices<
      TImplementation,
  ...
  > {
    typedef typename std::conditional<
      std::is_constructible<
        TImplementation, ConstructorArgument<ArgumentIndices>...
      >::value,
