...
#ifndef NUCLEX_SUPPORT_SERVICES_SERVICECOLLECTION_H
#define NUCLEX_SUPPORT_SERVICES_SERVICECOLLECTION_H

#include "Nuclex/Support/Config.h"

#include "Nuclex/Support/Services/ServiceLifetime.h" // for ServiceLifetime
#include "Nuclex/Support/Services/ServiceProvider.h" // for ServiceProvider
...
#include "Nuclex/Support/Services/Private/IsInjectableType.inl"
#include "Nuclex/Support/Services/Private/IsServiceInstanceType.inl"

#include "Nuclex/Support/Services/Private/ConstructorSignature.inl"
#include "Nuclex/Support/Services/Private/ConstructorArgument.inl"
#include "Nuclex/Support/Services/Private/ConstructorSignatureDetector.inl"
#include "Nuclex/Support/Services/Private/ServiceFactory.inl"
  ...
  inline ServiceCollection &ServiceCollection::AddTransient(
    ...
    AddPrototypedService(
      ...
      [](const std::any &prototypeAsAny) -> std::any { // only used if service is transient
        (void)prototypeAsAny; // avoids spurious compiler warning on MSVC
...
#endif // NUCLEX_SUPPORT_SERVICES_SERVICECOLLECTION_H
