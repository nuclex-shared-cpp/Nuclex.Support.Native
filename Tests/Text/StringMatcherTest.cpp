...
namespace Nuclex::Support::Text {
  ...
  TEST(StringMatcherTest, CanFindSubstringCaseInsensitive) {
    EXPECT_EQ(StringMatcher::Find<false>(u8"Hello World", u8"hello"), 0U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"Hello World", u8"world"), 6U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"Hello World", u8"o w"), 4U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"Hello World", u8"world!"), std::string::npos);
    EXPECT_EQ(StringMatcher::Find<false>(u8"Hello World", u8"Hello World"), 0U);
  ...
  TEST(StringMatcherTest, FindHandlesEmptyNeedleCaseInsensitive) {
    EXPECT_EQ(StringMatcher::Find<false>(u8"Hello World", u8""), 0U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"", u8""), 0U);
  }

  // ------------------------------------------------------------------------------------------- //

  TEST(StringMatcherTest, CanFindSubstringCaseSensitive) {
    EXPECT_EQ(StringMatcher::Find<true>(u8"Hello World", u8"Hello"), 0U);
    EXPECT_EQ(StringMatcher::Find<true>(u8"Hello World", u8"World"), 6U);
    EXPECT_EQ(StringMatcher::Find<true>(u8"Hello World", u8"o W"), 4U);
    EXPECT_EQ(StringMatcher::Find<true>(u8"Hello World", u8"world"), std::string::npos);
    EXPECT_EQ(StringMatcher::Find<true>(u8"Hello World", u8"Hello World"), 0U);
  ...
  TEST(StringMatcherTest, FindHandlesEmptyNeedleCaseSensitive) {
    EXPECT_EQ(StringMatcher::Find<true>(u8"Hello World", u8""), 0U);
    EXPECT_EQ(StringMatcher::Find<true>(u8"", u8""), 0U);
  }

  // ------------------------------------------------------------------------------------------- //

  TEST(StringMatcherTest, CanFindUtf8SubstringCaseInsensitive) {
    EXPECT_EQ(StringMatcher::Find<false>(u8"HellØ WØrld", u8"hellø"), 0U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"HellØ WØrld", u8"wørld"), 7U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"HellØ WØrld", u8"ø w"), 4U);
    EXPECT_EQ(StringMatcher::Find<false>(u8"HellØ WØrld", u8"wørld!"), std::string::npos);
    EXPECT_EQ(StringMatcher::Find<false>(u8"HellØ WØrld", u8"HellØ WØrld"), 0U);
  ...
  TEST(StringMatcherTest, CanFindUtf8SubstringCaseSensitive) {
    EXPECT_EQ(StringMatcher::Find<true>(u8"HellØ WØrld", u8"HellØ"), 0U);
    EXPECT_EQ(StringMatcher::Find<true>(u8"HellØ WØrld", u8"WØrld"), 7U);
    ...
    EXPECT_EQ(StringMatcher::Find<true>(u8"HellØ WØrld", u8"HellØ WØrld"), 0U);
