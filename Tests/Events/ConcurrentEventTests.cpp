...
namespace {
  ...
  class Mock {
    ...
    /// <remarks>
    ///   ConcurrentEvent subscribers are allowd to unsubscribe themselves from within the
    ///   notification callback. This is used to test that scenario.
    /// </remarks>
    public: Nuclex::Support::Events::ConcurrentEvent<void(int something)> *ToUnsubscribe;

    /// <summary>When set, subscribes the Notify() method inside the event call</summary>
    /// <remarks>
    ///   ConcurrentEvent subscribers are allowd to subscribe themselves or others from within
    ///   the notification callback. This is used to test that scenario.
    /// </remarks>
    public: Nuclex::Support::Events::ConcurrentEvent<void(int something)> *ToSubscribe;
...
namespace Nuclex::Support::Events {
  ...
  TEST(ConcurrentEventTest, ConcurrentEventCanHandleManySubscriptions) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, FreeFunctionsCanBeUnsubscribed) {
    ConcurrentEvent<void(int something)> test;
    test.Subscribe<freeFunction>();
  ...
  TEST(ConcurrentEventTest, EachSubscriptionRequiresOneUnsubscription) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, ObjectMethodsCanBeSubscribed) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, ObjectMethodsCanBeUnsubscribed) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, ConstObjectMethodsCanBeSubscribed) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, ConstObjectMethodsCanBeUnsubscribed) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, ConstObjectMethodsCanBeSubscribedOnConstInstance) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, ConstObjectMethodsCanBeUnsubscribedOnConstInstance) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, NotificationsAreSentToSubscribers) {
    ConcurrentEvent<void(int something)> test;
  ...
  TEST(ConcurrentEventTest, SubscriberReturnValuesCanBeDiscarded) {
    const static std::size_t SubscriberCount = 16;
  ...
  TEST(ConcurrentEventTest, ReturnValueListIsEmptyWithoutSubscribers) {
    ConcurrentEvent<int()> test;
    std::vector<int> results = test();
  ...
  TEST(ConcurrentEventTest, SubscriberReturnValuesCanBeCollectedWithoutAllocating) {
    const static std::size_t SubscriberCount = 16;
