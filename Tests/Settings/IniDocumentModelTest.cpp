...
namespace {
  ...
  const char8_t EmptyAssignments[] =
    u8"WithoutValue=\n"
    u8"\n"
    u8"[ MoreStuff ]\n"
    u8"AlsoNoValue = ;\n"
  ...
  const char8_t MultilineStrings[] =
    u8"Multiline = \"\n"
    u8"  Hello World\n"
    u8"\"\n"
    u8"[Section]\n"
...
namespace Nuclex { namespace Support { namespace Settings {
  ...
  TEST(IniDocumentModelTest, DefaultConstructedModelHasNoSections) {
    IniDocumentModel dom;
    std::vector<std::u8string> sections = dom.GetAllSections();
  ...
  TEST(IniDocumentModelTest, CanParseVanillaProperty) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(std::u8string(), u8"GlobalProperty");
  ...
  TEST(IniDocumentModelTest, CanParseVanillaSection) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"ImportantStuff", u8"Normal");
    ASSERT_TRUE(value.has_value());
  ...
  TEST(IniDocumentModelTest, IgnoresComments) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"ImportantStuff", u8"CommentedOut");
  ...
  TEST(IniDocumentModelTest, AssignmentWithoutValueIsValid) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(std::u8string(), u8"WithoutValue");
    ASSERT_TRUE(value.has_value());
    EXPECT_EQ(value.value(), std::u8string());
  }
  ...
  TEST(IniDocumentModelTest, SectionCanBePaddedWithSpaces) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"MoreStuff", u8"AlsoNoValue");
  ...
  TEST(IniDocumentModelTest, CommentAfterPropertyValueIsOmitted) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"MoreStuff", u8"AlsoNoValue");
    ASSERT_TRUE(value.has_value());
    EXPECT_EQ(value.value(), std::u8string(u8""));
  ...
  TEST(IniDocumentModelTest, SpacesAfterPropertyValueAreIgnored) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"MoreStuff", u8"TrailingSpaces");
    ASSERT_TRUE(value.has_value());
  ...
  TEST(IniDocumentModelTest, SpacesInsideQuotesAreKept) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"MoreStuff", u8"Quoted");
    ASSERT_TRUE(value.has_value());
    EXPECT_EQ(value.value(), u8"Hello ");
  }
  ...
  TEST(IniDocumentModelTest, UnclosedQuoteInvalidatesLine) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(u8"MoreStuff", u8"WeirdOne");
  ...
  TEST(IniDocumentModelTest, MalformedLinesAreIgnored) {
    ...
    EXPECT_FALSE(
      dom.GetPropertyValue(std::u8string(), u8"ThisLineIsMeaningless").has_value()
    );
    EXPECT_FALSE(
      dom.GetPropertyValue(std::u8string(), u8"]BadLine1").has_value()
    );
    EXPECT_FALSE(
      dom.GetPropertyValue(std::u8string(), u8"BadLine1").has_value()
    );
    EXPECT_FALSE(
      dom.GetPropertyValue(std::u8string(), u8"BadLine2").has_value()
    );
    EXPECT_FALSE(
      dom.GetPropertyValue(std::u8string(), u8"\"BadLine2").has_value()
    );
  ...
  TEST(IniDocumentModelTest, PropertyNameCanHaveBrackets) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(std::u8string(), u8"NotASection");
    EXPECT_TRUE(value.has_value());
  }
  ...
  TEST(IniDocumentModelTest, PropertyNameAndValueCanHaveBrackets) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(std::u8string(), u8"AlsoNoSection");
    ASSERT_TRUE(value.has_value());
  ...
  TEST(IniDocumentModelTest, AllMalformedElementsAreIgnored) {
    ...
    std::vector<std::u8string> sections = dom.GetAllSections();
    for(std::size_t index = 0; index < sections.size(); ++index) {
      if(sections[index].find(u8"Bad") != std::u8string::npos) {
        badSectionOrPropertyFound = true;
      }
    }
    for(std::size_t sectionIndex = 0; sectionIndex < sections.size(); ++sectionIndex) {
      std::vector<std::u8string> properties = dom.GetAllProperties(sections[sectionIndex]);
      for(std::size_t propertyIndex = 0; propertyIndex < properties.size(); ++propertyIndex) {
        if(properties[propertyIndex].find(u8"Bad") != std::u8string::npos) {
          badSectionOrPropertyFound = true;
        }
      }
    }
  ...
  TEST(IniDocumentModelTest, NewPropertiesCanBeCreated) {
    ...
    dom.SetPropertyValue(std::u8string(), u8"Hello", u8"World");

    std::vector<std::byte> fileContents = dom.Serialize();

    std::u8string fileContentsAsString(
      reinterpret_cast<const char8_t *>(fileContents.data()), fileContents.size()
    );
    EXPECT_TRUE(fileContentsAsString.find(u8"Hello = World") != std::u8string::npos);
  }
  ...
  TEST(IniDocumentModelTest, QuotedStringsCanContainLineBreaks) {
    ...
    std::optional<std::u8string> value = dom.GetPropertyValue(std::u8string(), u8"Multiline");
#if defined(ALLOW_NEWLINES_IN_QUOTED_STRINGS)
    ASSERT_TRUE(value.has_value());
    EXPECT_EQ(value.value(), std::u8string(u8"\n  Hello World\n"));
#else
...
#if defined(ALLOW_NEWLINES_IN_QUOTED_STRINGS)
    ASSERT_TRUE(value.has_value());
    EXPECT_EQ(value.value(), std::u8string(u8"Hello # World\n# Again"));
#else
    EXPECT_FALSE(value.has_value());
#endif
  }
  ...
  TEST(IniDocumentModelTest, EqualsSignCanBeUsedInValue) {
    ...
    }
    {
      ...
      std::optional<std::u8string> value = dom.GetPropertyValue(u8"Section", u8"Option");
      ASSERT_TRUE(value.has_value());
      EXPECT_EQ(value.value(), std::u8string(u8"Property=Value"));

      value = dom.GetPropertyValue(u8"Section", u8"ChangedOption");
      ASSERT_TRUE(value.has_value());
      EXPECT_EQ(value.value(), std::u8string(u8"New=Value"));
    }
  }
